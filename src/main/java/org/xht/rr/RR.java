...
@Slf4j
public class RR {
    private static final RR self = new RR();

    public RR dataSourceConfig(Consumer<RRDataSourceConfig> dataSourceConfig) {
    ...
    public static RR setConnection(Connection connection) {
